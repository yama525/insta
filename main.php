...
$(".gall_move_btn").on("click", function () {
        ...
        // ラジオボタンの値を取得
        g_chks = $('[class="radio_box"]:checked').map(function(){
        ...
        $('input[class="checkbox"]:checked').each(function(){
            ...
            //Ajax（非同期通信）ーーーーーーーー
                // params.append('id',   ); //「pg_relation_table」だから id は必要ないかも。
                params.append('g_id', g_chks); // ラジオボタンなので、1 情報だけ取得
                params.append('p_r_id', p_chks);  //axios 用
